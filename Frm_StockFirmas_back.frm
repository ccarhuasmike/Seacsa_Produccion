...
Private Function TokenDavicloud(ByRef v_id_transac As Integer, ByVal vNum_poliza As String) As String
        ...
        If (respStatusCode >= 400) Then
            v_id_transac = SP_LOG_API_DOC(vgUsuario, vNum_poliza, "/API/sign/v1/api_rest.php/access_token", "1", sbResponseBody.GetAsString)
        '    Debug.Print "Response Status Code = " & respStatusCode
        ...
        '    MsgBox sbResponseBody.GetAsString()
            Exit Function
        Else
          v_id_transac = SP_LOG_API_DOC(vgUsuario, vNum_poliza, "/API/sign/v1/api_rest.php/access_token", "0", "Tocken davidCloud obtenido correctamente")
        End If
...
Private Sub Reg_Firmantes_stock(ByVal pToken As String, ByRef vFirmante As Firmantes_Stock, ByVal v_id_transac As Integer)
            ...
            Else
                ...
                Else
                     ...
                     SP_LOG_API_DOC2_STOCK vgUsuario, v_id_transac, "/API/sign/v1/api_rest.php/registra_firmante", "0", p.Item("message")
                End If
