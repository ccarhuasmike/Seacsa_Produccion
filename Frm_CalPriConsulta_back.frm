...
End Sub
    ...
    Dim Titulos(17) As String
 
    Titulos(0) = "Poliza"
    Titulos(1) = "Nombre Titular"
    Titulos(2) = "AFP"
    Titulos(3) = "Tipo Prestación"
    Titulos(4) = "Fec. Incor."
    Titulos(5) = "Prima Total"
    Titulos(6) = "Prima Transferida"
    Titulos(7) = "Comisión"
    Titulos(8) = "NroDoc Asesor"
    Titulos(9) = "AsesorJV"
    Titulos(10) = "NroDoc Supervisor"
    Titulos(11) = "Supervisor"
    Titulos(12) = "NroDoc Jefe"
    Titulos(13) = "Jefe"
    Titulos(14) = "Traspaso"
    Titulos(15) = "CUSPP"
    Titulos(16) = "Mes Dif."
    Titulos(17) = "Fec. 1er Pago"
    
    vTotaCampos = 18
      
    vFila = 2
    Obj_Hoja.Cells(vFila, 1) = "PROTECTA"
    Obj_Hoja.Cells(vFila, 17) = "FECHA"
    Obj_Hoja.Cells(vFila, 18).NumberFormat = "@"
    Obj_Hoja.Cells(vFila, 18) = Format(Now, "dd/MM/yyyy")
    Obj_Hoja.rows(vFila).Font.Bold = True
    vFila = 5

    Obj_Hoja.Cells(vFila, 1) = "Listado de Todas las Polizas Informadas por Rango de Fechas"
    Obj_Hoja.Range("A5:R5").MergeCells = True
    ...
    Obj_Hoja.rows(vFila).Font.Bold = True
     ...
     Obj_Hoja.rows(vFila).Font.Bold = True
     Obj_Hoja.Range("A6:R6").MergeCells = True
     Obj_Hoja.Cells(vFila, 1).HorizontalAlignment = xlCenter
     
    
     Obj_Hoja.Columns("A:E").NumberFormat = "@"
     Obj_Hoja.Columns("I:P").NumberFormat = "@"
     Obj_Hoja.Columns("R").NumberFormat = "@"
     Obj_Hoja.Columns("F:H").NumberFormat = "######,##0.00"
    ...
    Next
     ...
     Obj_Hoja.Range("A12:R12").Borders.LineStyle = xlContinuous
     Obj_Hoja.Range("A12:R12").VerticalAlignment = xlVAlignCenter
     Obj_Hoja.Range("A12:R12").Font.Bold = True
